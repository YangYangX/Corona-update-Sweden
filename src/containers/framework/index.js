...
class Framework extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Menu fixed='top' stackable className={"toolbar"} inverted>
          <Menu.Item>
            ...
            >
              {"cn" === language ? (
                <>
                  <img src={enIcon} style={{ width: "32px", height: "32px" }} />
                </>
              ) : null}
              {"en" == language ? (
                <>
                  <img src={cnIcon} style={{ width: "32px", height: "32px" }} />
                </>
              ) : null}
            </Responsive>
          </Menu.Item>
                                  ...
                                  <Grid.Row>
                                    <Grid.Column width={10}>
                                      ...
                                      <List link inverted>
                                        ...
                                        <List.Item
                                          as="a"
                                          href={"mailto: yangy@zkhoneycomb.com"}
                                        >
                                          {t("common:contact")}
                                        </List.Item>
                                      </List>
